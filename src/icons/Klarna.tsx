...
const Klarna = ({ style }: TSVGIcon) => {
	return (
		...
		>
			...
			<rect className='cls-1' width={120} height={80} rx={4} />
			<rect
				className='cls-1'
				x={10}
				y={12.22}
